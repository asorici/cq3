...
\begin{center}
  ...
  {\huge Team \textbf{ {{escapedteamname}} } Report}
\end{center}
    ...
    \hline
      ...
      {% for teamitem in teamscores %} 
        {% if teamitem.team_id == thisteamid %} 
          {{escapedteamname}} & {{ teamitem.w }} & {{ teamitem.d }} & {{ teamitem.l }} & {{ teamitem.total_points }} \\
          \hline  
          {% else %}
            {{teamitem.label}} & {{ teamitem.w }} & {{ teamitem.d }} & {{ teamitem.l }} & {{ teamitem.total_points }} \\
            \hline  
            {% endif %}
              {% endfor %}
