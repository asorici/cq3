...
\begin{center}
  ...
  {\huge Team \textbf{ Tactics\_Games } Report}
\end{center}
...
\end{minipage}
  ...
  \vspace*{2em}
  \par {\large {\color{Gray} Team} Tactics\_Games {\color{Gray}
      vs. Team} T8}
  \newline
  \begin{tabular}[t]{| c | c | c | c | c | c | c | c | c | c | c | c
    ...
    Starting Position & \textbf{Result} & Player & \textbf{Score} & K & RK & DU & PTower & STrap & PTrap & KS & FB \\
        ...
        \multirow{2}{*}{  ULC  } &
              \multirow{2}{*}{  \textbf{L}  } & 
                    \cellcolor{yellow!25} You & \cellcolor{yellow!25} 2.0 & \cellcolor{yellow!25} 2 &
                    \cellcolor{yellow!25} 0 & \cellcolor{yellow!25} 12 & \cellcolor{yellow!25} 0 &
                    \cellcolor{yellow!25} 0 & \cellcolor{yellow!25} 0 & \cellcolor{yellow!25} 0 &
                    \cellcolor{yellow!25} 0 \\
                    \cline{3-12}
                    & & \cellcolor{red!15} Foe & \cellcolor{red!15} 37.0 & \cellcolor{red!15} 12 & \cellcolor{red!15}
  ...
  \begin{tabular}[t]{| c | c | c | c | c | c | c | c | c | c | c | c
    ...
    Starting Position & \textbf{Result} & Player & \textbf{Score} & K & RK & DU & PTower & STrap & PTrap & KS & FB \\
        ...
        \multirow{2}{*}{  ULC  } &
              \multirow{2}{*}{  \textbf{W}  } & 
                    \cellcolor{yellow!25} You & \cellcolor{yellow!25} 71.0 & \cellcolor{yellow!25} 16 &
                    \cellcolor{yellow!25} 0 & \cellcolor{yellow!25} 0 & \cellcolor{yellow!25} 0 &
                    \cellcolor{yellow!25} 0 & \cellcolor{yellow!25} 0 & \cellcolor{yellow!25} 3 &
                    \cellcolor{yellow!25} 1 \\
                    \cline{3-12}
                    & & \cellcolor{red!15} Foe & \cellcolor{red!15} 0.0 & \cellcolor{red!15} 0 & \cellcolor{red!15}
                    0 & \cellcolor{red!15} 16
                    & \cellcolor{red!15} 0 & \cellcolor{red!15}
                    0 & \cellcolor{red!15} 0 
                    & \cellcolor{red!15} 0 & \cellcolor{red!15}
                    0 \\
  ...
  \begin{tabular}[t]{| c | c | c | c | c | c | c | c | c | c | c | c
    ...
    Starting Position & \textbf{Result} & Player & \textbf{Score} & K & RK & DU & PTower & STrap & PTrap & KS & FB \\
        ...
        \multirow{2}{*}{  ULC  } &
              \multirow{2}{*}{  \textbf{W}  } & 
                    \cellcolor{yellow!25} You & \cellcolor{yellow!25} 33.0 & \cellcolor{yellow!25} 8 &
                    \cellcolor{yellow!25} 0 & \cellcolor{yellow!25} 0 & \cellcolor{yellow!25} 0 &
                    \cellcolor{yellow!25} 0 & \cellcolor{yellow!25} 0 & \cellcolor{yellow!25} 1 &
                    \cellcolor{yellow!25} 1 \\
                    \cline{3-12}
                    & & \cellcolor{red!15} Foe & \cellcolor{red!15} 0.0 & \cellcolor{red!15} 0 & \cellcolor{red!15}
                    0 & \cellcolor{red!15} 8
                    & \cellcolor{red!15} 0 & \cellcolor{red!15}
                    0 & \cellcolor{red!15} 0 
                    & \cellcolor{red!15} 0 & \cellcolor{red!15}
                    0 \\
  ...
  \begin{tabular}[t]{| c | c | c | c | c | c | c | c | c | c | c | c
    ...
    Starting Position & \textbf{Result} & Player & \textbf{Score} & K & RK & DU & PTower & STrap & PTrap & KS & FB \\
        ...
        \multirow{2}{*}{  ULC  } &
              \multirow{2}{*}{  \textbf{L}  } & 
                    \cellcolor{yellow!25} You & \cellcolor{yellow!25} 5.0 & \cellcolor{yellow!25} 5 &
                    \cellcolor{yellow!25} 0 & \cellcolor{yellow!25} 9 & \cellcolor{yellow!25} 0 &
                    \cellcolor{yellow!25} 0 & \cellcolor{yellow!25} 0 & \cellcolor{yellow!25} 0 &
                    \cellcolor{yellow!25} 0 \\
                    \cline{3-12}
                    & & \cellcolor{red!15} Foe & \cellcolor{red!15} 19.0 & \cellcolor{red!15} 9 & \cellcolor{red!15}
  ...
  \begin{tabular}[t]{| c | c | c | c | c | c | c | c | c | c | c | c
    ...
    Starting Position & \textbf{Result} & Player & \textbf{Score} & K & RK & DU & PTower & STrap & PTrap & KS & FB \\
        ...
        \multirow{2}{*}{  ULC  } &
              \multirow{2}{*}{  \textbf{W}  } & 
                    \cellcolor{yellow!25} You & \cellcolor{yellow!25} 73.0 & \cellcolor{yellow!25} 18 &
                    \cellcolor{yellow!25} 0 & \cellcolor{yellow!25} 0 & \cellcolor{yellow!25} 0 &
                    \cellcolor{yellow!25} 0 & \cellcolor{yellow!25} 0 & \cellcolor{yellow!25} 3 &
                    \cellcolor{yellow!25} 1 \\
                    \cline{3-12}
                    & & \cellcolor{red!15} Foe & \cellcolor{red!15} 0.0 & \cellcolor{red!15} 0 & \cellcolor{red!15}
                    0 & \cellcolor{red!15} 18
                    & \cellcolor{red!15} 0 & \cellcolor{red!15}
                    0 & \cellcolor{red!15} 0 
                    & \cellcolor{red!15} 0 & \cellcolor{red!15}
                    0 \\
  ...
  \begin{tabular}[t]{| c | c | c | c | c | c | c | c | c | c | c | c
    ...
    Starting Position & \textbf{Result} & Player & \textbf{Score} & K & RK & DU & PTower & STrap & PTrap & KS & FB \\
        ...
        \multirow{2}{*}{  ULC  } &
              \multirow{2}{*}{  \textbf{L}  } & 
                    \cellcolor{yellow!25} You & \cellcolor{yellow!25} 25.0 & \cellcolor{yellow!25} 25 &
                    \cellcolor{yellow!25} 0 & \cellcolor{yellow!25} 37 & \cellcolor{yellow!25} 0 &
                    \cellcolor{yellow!25} 0 & \cellcolor{yellow!25} 0 & \cellcolor{yellow!25} 0 &
                    \cellcolor{yellow!25} 0 \\
                    \cline{3-12}
                    & & \cellcolor{red!15} Foe & \cellcolor{red!15} 92.0 & \cellcolor{red!15} 37 & \cellcolor{red!15}
                    0 & \cellcolor{red!15} 25
                    & \cellcolor{red!15} 0 & \cellcolor{red!15}
                    0 & \cellcolor{red!15} 0 
        ...
        \multirow{2}{*}{  URC
              ...
              \multirow{2}{*}{  \textbf{W}  } & 
                    \cellcolor{yellow!25} You & \cellcolor{yellow!25} 13.0 & \cellcolor{yellow!25} 3 &
                    \cellcolor{yellow!25} 0 & \cellcolor{yellow!25} 0 & \cellcolor{yellow!25} 0 &
                    \cellcolor{yellow!25} 0 & \cellcolor{yellow!25} 0 & \cellcolor{yellow!25} 0 &
                    \cellcolor{yellow!25} 1 \\
                    \cline{3-12}
                    & & \cellcolor{red!15} Foe & \cellcolor{red!15} 0.0 & \cellcolor{red!15} 0 & \cellcolor{red!15}
                    0 & \cellcolor{red!15} 3
                    & \cellcolor{red!15} 0 & \cellcolor{red!15}
                    0 & \cellcolor{red!15} 0 
                    & \cellcolor{red!15} 0 & \cellcolor{red!15}
                    0 \\
